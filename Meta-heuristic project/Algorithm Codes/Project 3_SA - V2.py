...
'''inputs'''
os.chdir('input')
questionInput = open('Prob-45A-50.txt', 'r')
...
print(Profit_Solution(s0))
print(*s0, sep = "\n")
# print(*s0)
print('********  improved solution by SA')
...
def SA_VRP(S0):
    ...
    while T > T_0:
        ...
        i= 0
        T = T*alpha
    record=[num, sBest, profitbest, profitbest-oriprofit, T]
    return record
#print(NEIGHBOR_VRP(s0,nn))
#print(RandomBFS())
ans= SA_VRP(s0)
