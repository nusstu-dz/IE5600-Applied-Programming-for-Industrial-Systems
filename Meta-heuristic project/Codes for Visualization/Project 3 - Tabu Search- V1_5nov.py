...
# Initial_VRP(data)
record = tabusearch() # change this to the correct metaheuristics. need to tweak the metaheuristics to append ALL solutions to record instead of discarding
...
anim.save('./proj3_Tabu_30A_RandomBFS.gif', writer='imagemagick', fps=10) # change fps if you want gif to run faster. Also can change your filename here
